<%@page import="com.hms.entity.Doctor"%> <%@page import="java.util.List"%> <%@page import="com.hms.db.DBConnection"%> <%@page import="com.hms.dao.DoctorDAO"%> <%@ page language="java" contentType="text/html; charset=UTF-8" pageEncoding="UTF-8"%>
...
<!DOCTYPE html> <html> <head> <meta charset="UTF-8"> <title>User Appointment Page</title> <!-- all css include --> <%@include file="../component/allcss.jsp"%> <!-- customs css for this page --> <style type="text/css"> .my-card { box-shadow: 0px 0px 10px 1px maroon; /*box-shadow: 0px 0px 10px 0px rgba(0,0,0,0.3);*/ } /* backgournd image css */ .my-bg-img{ background: linear-gradient(rgba(0, 0, 0, .4), rgba(0, 0, 0, .4)),url("img/hospital1.jpg"); height: 20vh; width: 100%; background-size:cover; background-repeat: no-repeat; } /* backgournd image css */ </style> <!-- end of customs css for this page --> </head> <body> <%@include file="component/navbar.jsp"%>
<!-- start 1st Div -->
		...
		<div class="col-md-6">
			<div class="card my-card">
				<div class="card-body">
					...
					<!-- boostrap form -->
<form class="row g-3" id="appointmentForm" action="addAppointment" method="post">
						...
						<c:if test="${not empty userObj}">
							...
							<div class="col-md-12">
								<!--<button type="submit" class="btn my-bg-color text-white col-md-12" >Submit</button>-->
                                                                 <!--<input type="hidden" id="razorpayPaymentId" name="razorpay_payment_id" />-->
<button type="button" onclick="submitAppointmentThenPay()" class="btn my-bg-color text-white col-md-12">Book & Pay</button>
							</div>
...
<script>
function submitAppointmentThenPay() {
    var formData = $("#appointmentForm").serialize(); // get all form data
    ...
    $.ajax({
        ...
        success: function(response) {
            // Response from servlet doesn't matter as much because we continue to Razorpay
...
function openRazorpayCheckout() {
    var options = {
        "key": "rzp_test_h3e4dGfdUTqlTi", // Replace with your Razorpay key
        "amount": 20000, // Amount in paisa = ₹200
        "currency": "INR",
        "name": "DocConnect",
